...
class ReminderAdapter(private val mCallback: AdapterCallback, private val list: List<Reminders>) : ListAdapter<Reminders, ReminderAdapter.TransactionTextViewHolder>(DiffCallback()) {
